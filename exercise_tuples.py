...
# print(convert_coordinate("1F"))  # ("1", "F")
# print(convert_coordinate("4B"))  # ("4", "B")
...
def create_record(registro_azara, registro_rui):
    ...
    if coordenada_azara == coordenada_rui:
        return ( registro_azara[0], get_coordinate(registro_azara), registro_rui[0], coordenada_rui, registro_rui[-1] )
    else:
        return "not a match"
